function onClickLikeButton() {
    if (document.getElementById("puppyImage").src === "https://d1tgh8fmlzexmh.cloudfront.net/ccbp-dynamic-webapps/white-puppy-img.png") {
    ...
    } else if (document.getElementById("puppyImage").src === "https://d1tgh8fmlzexmh.cloudfront.net/ccbp-dynamic-webapps/white-puppy-liked-img.png") {
